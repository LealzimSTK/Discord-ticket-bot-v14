        ...
        return message.reply({
            ...
            embeds: [
                new EmbedBuilder()
                    ...
                    .setDescription(`Ola, você me chamou? Prazer em conhecê-lo. Digite \`/\`  clique no meu logotipo para ver todos os meus comandos.\n\nUse \`/ajuda\` para obter uma visão geral sobre os comandos. \n\n*Esta mensagem será apagada em \`10 segundos\`!*`)
                    .setThumbnail(user.displayAvatarURL())
                    .setFooter({ text: "Introduction to FireTicket" })
                    .setTimestamp()
            ],
